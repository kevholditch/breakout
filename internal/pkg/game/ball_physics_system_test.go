...
func Test_BallPhysicsSystem(t *testing.T) {
	testCases := []struct {
		name                 string
		blocks               []*BlockEntity
		playerState          *PlayerStateComponent
		playerQuad           *Quad
	...
	}{
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Kickoff},
			ball:                 NewBallPhysicsComponent([2]float32{0, 0}, NewCircleWithColour(300, 300, 12, colourWhite)),
		...
		},
		{
			...
			playingSpace:         NewPlayingSpace(800, 600),
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{-1, 0}, NewCircleWithColour(1, 300, 12, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{1, 0}, NewCircleWithColour(799, 300, 12, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{0, -1}, NewCircleWithColour(100, 71, 10, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{0, -1}, NewCircleWithColour(200, 71, 10, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{0, -1}, NewCircleWithColour(90, 71, 10, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{0, -1}, NewCircleWithColour(210, 71, 10, colourWhite)),
		...
		// hit blocks
		{
			...
			blocks: []*BlockEntity{
				NewBlockEntity(NewRenderComponent(NewQuadWithColour(500, 500, 100, 50, colourWhite))),
			},
			playingSpace:         NewPlayingSpace(800, 600),
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{0, -1}, NewCircleWithColour(550, 561, 10, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{10, -1}, NewCircleWithColour(550, 561, 10, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{1, 0}, NewCircleWithColour(489, 525, 10, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{1, 10}, NewCircleWithColour(489, 525, 10, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{0, 1}, NewCircleWithColour(550, 489, 10, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{10, 1}, NewCircleWithColour(550, 489, 10, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{-1, 0}, NewCircleWithColour(611, 525, 10, colourWhite)),
		...
		},
		{
			...
			playerQuad:           NewQuadWithColour(100, 40, 100, 20, colourCoral),
			playerState:          &PlayerStateComponent{State: Playing},
			ball:                 NewBallPhysicsComponent([2]float32{-1, 10}, NewCircleWithColour(611, 525, 10, colourWhite)),
